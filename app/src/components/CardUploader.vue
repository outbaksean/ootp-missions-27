            ...
            <div class="modal-body help-body">
              ...
              <details open>
                ...
                <p>
                  ...
                  upload the CSV under User Cards. This provides prices and
                  owned status. If you want lock status displayed, also export
                  your locked card report with PT Card ID and PT Lock columns
                  and upload it under Card Locks.
                </p>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    locked status in the app. This does not apply to owned
                    status as that comes from the shop export which doesn't have
                    this issue.
                  </li>
                </ul>
              </details>
              ...
              <details open>
                ...
                <p>
                  Each row shows an overview of mission completion cost and
                  value. Calculations update automatically as data and settings
                  change.
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    Reward: market value of the mission prize. Set pack values
                    in the sidebar to override the default pack rewards.
                  </li>
                  <li>
              ...
              <details open>
                ...
                <ul>
                  ...
                  <li>
                    Set Completed: manual completion for missions you can
                    finish. This does not change the lock status of any cards.
                  </li>
                </ul>
              </details>
              ...
              <details open>
                ...
                <ul>
                  ...
                  <li>
                    Use Sell Price: uses lowest active sell order instead of
                    last 10 price.
                  </li>
                  <li>
              ...
              <details open>
                ...
                <ul>
                  ...
                  <li>
                    Mission Completion: prioritizes completing missions
                    attempting to complete all missions by lowest cost first.
                  </li>
                  <li>
                    Available PP: Sets the max amount of PP to spend on cards.
                  ...
                  <li>
                    Export buttons generate a CSV card list or a full HTML
                    report with summary and exclusions.
                  </li>
                </ul>
              </details>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="card-body">
                ...
                <ul>
                  <li>
                    Currently using OOTP 26 data with plans to migrate to OOTP
                    27 missions and cards on or near release date
                  </li>
                  <li>
                    Updated mission calculation algorithm for a major
                    performance boost, removed greedy mode toggle
                  </li>
                  <li>
                    Added optimize card selection mode - this will change the
                    algorithm to show which unlocked cards you own but should
                    not lock because there's more value in buying other cards
                    and selling the owned one.
                  </li>
                  <li>
                  ...
                  <li>
                    The date missions were last uploaded is now shown on the
                    site.
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    When cards or updated or added I need to manually export
                    card data from the game and import into the app, this will
                    take well under an hour but requires manual work
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        failed. The data doesn't seem to be saved on a system
                        file and decrypting api requests with WireShark failed
                      </li>
                      <li>
